...
**How to apply:** Validate the selected country server-side as an opposing seated player before consuming the Hitman. Do not disclose the disabled card type to the targeted player; keep the attacker’s detailed result private.